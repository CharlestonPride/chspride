  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        >
          {logoUrl ? (
            ...
            <img src={logoUrl} alt={org.name} className="w-full h-full object-contain p-1" />
          ) : (
            <div
              className="w-full h-full rounded-xl"
              style={{ background: "var(--gradient-rainbow)", opacity: 0.5 }}
            />
          )}
        </div>
      ...
      <div className="flex gap-3 items-center flex-wrap">
        ...
        {org.facebook && (
          <SocialLink href={org.facebook} label={`${org.name} on Facebook`}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
