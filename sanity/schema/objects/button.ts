...
export default defineType({
    ...
    title: 'Button',
    type: 'object',
    description: 'Specify an External URL or an Internal Reference to another page.',
    fields: [
        defineField({
            name: 'label',
            title: 'Label',
        ...
        defineField({
            ...
            type: 'string',
            readOnly: true,
            initialValue: '⚡Specify an External URL OR an Internal Reference to another page.'
        }),
        defineField({
            name: 'url',
            title: 'External Url',
        ...
        defineField({
            ...
            type: 'reference',
            to: [{ type: 'page' }, { type: 'home' }, { type: 'ourTeam' }]
        }),
    ],
    validation: (rule) =>
        rule.custom((button) => {
