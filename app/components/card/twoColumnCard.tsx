...
const left = (props: TwoColumnCardProps, imageUrl: string, imgClass: string) => {
    return (
...
const right = (props: TwoColumnCardProps, imageUrl: string, imgClass: string) => {
    return (
        <Container className="my-5">
            <Row>
                <Col
...
export default function TwoColumnCard(props: Props) {
    ...
    if (props.stack) {
        return props.orientation === 'left' ? leftStacked(props, imageUrl) : rightStacked(props, imageUrl);
    }

    let imgClass = props.shadow
        ? "w-100  border-radius-lg shadow-card"
        : "w-100 border-radius-lg";
    return props.orientation == 'left' ? left(props, imageUrl, imgClass) : right(props, imageUrl, imgClass);
