...
export type Props = TwoColumnGalleryCardProps & { orientation: 'left' | 'right' }
...
const CardContent = (props: TwoColumnGalleryCardProps) => {
    ...
    return (
        <>
            ...
            <h3 className={"text-gradient mb-0 text-" + props.theme}>{props.title}</h3>
            ...
            <Row>
                ...
                <Col lg="8" className="ps-5 pe-0 d-none d-lg-block">
                    <Row className={"p-2 border-radius-xl bg-gradient-" + props.theme}>
                        <Col xs="6" lg="3">
                            {props.images && getImage(props?.images[0], 'w-100 border-radius-lg shadow mt-0 mt-lg-7')}
                        </Col>
                        <Col xs="6" lg="3">

                            {props.images && getImage(props?.images[1], "w-100 border-radius-lg shadow")}
                            {props.images && getImage(props?.images[2], "w-100 border-radius-lg shadow mt-4")}
                        </Col>
                        <Col xs="6" lg="3">
                            {props.images && getImage(props?.images[3], "w-100 border-radius-lg shadow mt-0 mt-lg-5")}
                            {props.images && getImage(props?.images[4], "w-100 border-radius-lg shadow mt-4")}
                        </Col>
                        <Col xs="6" lg="3">
                            {props.images && getImage(props?.images[5], "w-100 border-radius-lg shadow mt-3")}
                            {props.images && getImage(props?.images[6], "w-100 border-radius-lg shadow mt-4")}
                        </Col>
                    </Row>
                </Col>
            </Row>
