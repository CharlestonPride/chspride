...
import { HomeQueryResult, ImageGalleryCard as ImageGalleryCardProps, TwoColumnCard as TwoColumnCardProps, TwoColumnGalleryCard as TwoColumnGalleryCardProps } from "@/sanity/lib/sanity.types";
    ...
    <main >
      ...
      {props.content?.map(c => {
        if (c._type == 'twoColumnCard') {
          return <TwoColumnCard {...c as unknown as TwoColumnCardProps} orientation={sectionCount++ % 2 ? 'left' : 'right'}></TwoColumnCard>
        }
        ...
        if (c._type == 'twoColumnGalleryCard') {
          return <TwoColumnGalleryCard {...c as unknown as TwoColumnGalleryCardProps} orientation={sectionCount++ % 2 ? 'left' : 'right'}></TwoColumnGalleryCard>
        }
        return <></>
      })}
    </main>
