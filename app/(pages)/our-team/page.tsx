...
import { OurTeamQueryResult, Header as HeaderProps, Person } from "@/sanity/lib/sanity.types";
        ...
        return (
            <div className="position-relative">
                <div className="blur-shadow-image">
                    <SanityImage _key={props.name!} {...props.image} imgClass="w-100 rounded-3 shadow-lg" />
                </div>
            </div>
        );
    }
