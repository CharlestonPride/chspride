...
import { singletonPlugin } from "./plugins/setttings";
import footer from "./schema/documents/singletons/footer";
...
import { eventType, pageType, sponsorshipType, sponsorType } from "./schema/documents";
...
const pageStructure: StructureResolver = (S) => {
